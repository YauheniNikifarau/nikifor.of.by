...
$login_description_html = 'Защищено Бобой <img  src="' . Vite::asset('resources/images/boba.jpg') . '"
    style="width: 40px;
    height: 40px;
    object-fit: cover;
    border-radius: 50%;
...
return [
    ...
    'login' => [
        'title' => 'Добро пожаловать в Семейную Панель!',
        'description' => $login_description_html,
